      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          {hasMinted ? (
            ...
            <span 
              className="px-2 py-1 rounded text-xs font-mono uppercase animate-pulse"
              style={{ 
        ...
        <div className="px-4 pb-4">
          ...
          >
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="font-bold uppercase">PROMO MINT - NO VOT BURN</p>
          ...
          {canMint ? (
            ...
            >
              <p className="font-mono text-sm" style={{ color: MATRIX_DIM }}>
